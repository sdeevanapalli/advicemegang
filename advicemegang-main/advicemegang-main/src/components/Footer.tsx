      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Revolutionizing the automotive industry with cutting-edge cyberpunk technology 
              and sustainable electric performance.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-colors">Service Centers</a></li>
        ...
        <div className="border-t mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © 2024 CyberDrive. All rights reserved.
          </p>
